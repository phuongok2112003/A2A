...
class CustomsStoreBackend(BackendProtocol):
    ...
    def write(
        ...
        print(f"\n\nFile path trong write Custombackend {file_path}")
    ...
    async def awrite(
        ...
        print(f"\n\nFile path trong aCustombackend {file_path}")
    ...
    def edit(
        ...
        print(f"\n\nFile path trong edit Custombackend {file_path}")
    ...
    def upload_files(self, files: list[tuple[str, bytes]]) -> list[FileUploadResponse]:
        ...
        for path, content in files:
            ...
            # Store the file
            print(f"\n\nFile path trong upload_files Custombackend {path}")
